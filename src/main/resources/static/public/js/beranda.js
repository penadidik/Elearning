...
function loadKategoriKursus(){
    $.ajax({
        ...
        success: function (res) {
            ...
            while(i < 6){
                if(response[i] == null){
                    slide += '<div class="col-lg-2 col-md-3 mt-5"><div class="s-block"><a href="/kursus" class="d-block p-lg-4 p-3"><img src="'+gambar[i]+'" alt="" class="img-fluid" /><h3 class="my-3">'+judul[i]+'</h3><p class="">Our goal is to help our companies maintain or achieve best in class positions. Build an online presence with this professional bootstrap 4 template.</p></a></div></div>';
                }else{
...
function loadTestimoni(){
     $.ajax({
         ...
         success: function (res) {
            ...
            if(response[i] == null){
                testimoni += '<div class="item"><div class="row slider-info mt-lg-4 mt-3"><div class="col-md-1"></div><div class="col-md-2"><img src="'+gambar[0]+'" class="img-fluid rounded" alt="client image"></div><div class="col-md-8 text-left"><div class="row"><div class="col-md-2">Nama Lengkap</div><div class="col-md-1">:</div><div class="col-md-3">Member A</div></div><div class="row"><div class="col-md-2">Kelas Diikuti</div><div class="col-md-1">:</div><div class="col-md-3">Manajemen</div></div><div class="row"><div class="col-md-12">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id accusantium officia quod quasi necessitatibus perspiciatis Harum error provident quibusdam tenetur.</div> </div></div><div class="col-md-1"></div></div></div>';
            }else{
...
function loadKelasTerbaru(){
     $.ajax({
         ...
         success: function (res) {
             ...
             var kelas = '';
             if(response[i] == null){
                kelas += '<div class="list-inline-item box-product"><div class="col-md-12"><div class="row"><div class="col-md-3"><img src="'+gambar[0]+'" class="img-product"></div><div class="col-md-9"><div class="row"><div class="col-md-12"><div class="features15-para"><h4>Manajemen</h4><p>Our goal is to help our companies maintain or achieve best in class positions. Build an online presence with this professional bootstrap 4 template.</p></div></div><div class="col-md-12"><i>Pemateri:  <b>Pemateri 1</b></i></div></div></div></div><div class="row"><div class="col-md-12">&nbsp;</div></div><div class="row"><div class="btn btn-primary col-md-6">BELI KELAS ONLINE</div><div class="col-md-2"></div><div class="col-md-4 btn btn-light disabled">Rp. 50.000</div></div></div></div>';
                kelas += '<div class="list-inline-item box-product"><div class="col-md-12"><div class="row"><div class="col-md-3"><img src="'+gambar[1]+'" class="img-product"></div><div class="col-md-9"><div class="row"><div class="col-md-12"><div class="features15-para"><h4>Teknologi Informasi</h4><p>Our goal is to help our companies maintain or achieve best in class positions. Build an online presence with this professional bootstrap 4 template.</p></div></div><div class="col-md-12"><i>Pemateri:  <b>Pemateri 2</b></i></div></div></div></div><div class="row"><div class="col-md-12">&nbsp;</div></div><div class="row"><div class="btn btn-primary col-md-6">BELI KELAS ONLINE</div><div class="col-md-2"></div><div class="col-md-4 btn btn-light disabled">Rp. 50.000</div></div></div></div>';
                kelas += '<div class="list-inline-item box-product"><div class="col-md-12"><div class="row"><div class="col-md-3"><img src="'+gambar[2]+'" class="img-product"></div><div class="col-md-9"><div class="row"><div class="col-md-12"><div class="features15-para"><h4>Akuntansi</h4><p>Our goal is to help our companies maintain or achieve best in class positions. Build an online presence with this professional bootstrap 4 template.</p></div></div><div class="col-md-12"><i>Pemateri:  <b>Pemateri 3</b></i></div></div></div></div><div class="row"><div class="col-md-12">&nbsp;</div></div><div class="row"><div class="btn btn-primary col-md-6">BELI KELAS ONLINE</div><div class="col-md-2"></div><div class="col-md-4 btn btn-light disabled">Rp. 50.000</div></div></div></div>';
             }else{
                while(i < response.length){
                    kelas += '<div class="list-inline-item box-product"><div class="col-md-12"><div class="row"><div class="col-md-3"><img src="'+response[i].photoKelas+'" class="img-product"></div><div class="col-md-9"><div class="row"><div class="col-md-12"><div class="features15-para"><h4>'+response[i].namaKelas+'</h4><p>'+response[i].deskripsiKelas+'</p></div></div><div class="col-md-12"><i>Pemateri:  <b>'+response[i].pemateri+'</b></i></div></div></div></div><div class="row"><div class="col-md-12">&nbsp;</div></div><div class="row"><div class="btn btn-primary col-md-6">BELI KELAS ONLINE</div><div class="col-md-2"></div><div class="col-md-4 btn btn-light disabled">'+formatRupiah(response[i].hargaKelas,"Rp. ")+'</div></div></div></div>';
                    i++;
                }
             }
